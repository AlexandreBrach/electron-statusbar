...
BUS_NAME = 'org.alexandrebrach.toolbar.pomorodo'
OBJECT_PATH = '/org/alexandrebrach/toolbar/pomorodo'
...
class Emitter(dbus.service.Object):
    ...
    @dbus.service.method(dbus_interface=DBUS_INTERFACE, in_signature='', out_signature='s')
    def getState(self):
        return self.data
